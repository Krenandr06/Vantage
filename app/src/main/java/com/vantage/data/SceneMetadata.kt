...
val AllScenes: List<SceneMeta> = listOf(
    ...
    SceneMeta(
        ...
        story = "Three ridges receding into haze. The sun crosses the sky; clouds drift across the highest ridge. Snow appears on the cap in winter; valley mist gathers at dawn and dusk.",
        engine = listOf("seasons", "weather", "time-of-day"),
